...
typedef enum
{
    ...
    EXM_SEARCH_SORT_DOWNLOADS_DES = 1,
    EXM_SEARCH_SORT_UPDATED_DES = 2,
    EXM_SEARCH_SORT_CREATED_DES = 3,
    EXM_SEARCH_SORT_POPULARITY_ASC = 4,
    EXM_SEARCH_SORT_DOWNLOADS_ASC = 5,
    EXM_SEARCH_SORT_UPDATED_ASC = 6,
    EXM_SEARCH_SORT_CREATED_ASC = 7
} ExmSearchSort;
